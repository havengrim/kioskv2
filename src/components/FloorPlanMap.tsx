...
const divisions: Division[] = [
  ...
  { name: "PROTECTIVE SERVICES DIVISION CHIEF OFFICE", coordinates: [3, 6.5], floor: "floor3" },
  ...
  { name: "ICTMS OFFICE", coordinates: [6, 3], floor: "mainSecondFloor" },
  { name: "ACCOUNTING REVIEWER OFFICE", coordinates: [7.2, 3], floor: "mainSecondFloor" },
  { name: "BUDGET SECTION OFFICE", coordinates: [9, 3], floor: "mainSecondFloor" },
  { name: "BUDGET SECTION CHIEF", coordinates: [9.5, 4], floor: "mainSecondFloor" },
  { name: "ARDA'S STAFF OFFICE", coordinates: [9, 1.8], floor: "mainSecondFloor" },
  { name: "CONFERENCE AREA", coordinates: [9.5, 1], floor: "mainSecondFloor" },
  { name: "ASSISTANT REGIONAL DIRECTOR FOR ADMINISTRATIONS OFFICE", coordinates: [9, 1], floor: "mainSecondFloor" },
  { name: "ACCOUNTING SECTION OFFICE", coordinates: [7.5, 6.7], floor: "mainSecondFloor" },
  { name: "CASH SECTION OFFICE", coordinates: [9, 8], floor: "mainSecondFloor" },
  { name: "OFFICE OF THE REGIONAL DIRECTOR ADMIN OFFICE", coordinates: [2, 3], floor: "mainSecondFloor" },
  
  { name: "ICT SERVER ROOM", coordinates: [5, 1.4], floor: "mainSecondFloor" },
  { name: "FMD STAFF AREA", coordinates: [4, 1.4], floor: "mainSecondFloor" },
  { name: "FMD DC", coordinates: [3.5, 1.4], floor: "mainSecondFloor" },
  { name: "ARDO STAFF", coordinates: [2.5, 1.7], floor: "mainSecondFloor" },
  { name: "ASSISTANT REGIONAL DIRECTOR FOR OPERATIONS OFFICE", coordinates: [1.6, 1.3], floor: "mainSecondFloor" },
  { name: "OFFICE OF THE REGIONAL DIRECTOR", coordinates: [2, 3], floor: "mainSecondFloor" },
  { name: "KAGALINGAN LOUNGE", coordinates: [0.8, 3], floor: "mainSecondFloor" },
