...
import { SiGithub, SiTiktok, SiYoutube } from "react-icons/si"; // Removed Gitter, since it's not used
...
type BlockProps = {
  ...
  whileHover?: { rotate: string; scale: number };
};

const Block = ({ className, children, whileHover, ...rest }: BlockProps) => {
  return (
    <motion.div
      variants={{
